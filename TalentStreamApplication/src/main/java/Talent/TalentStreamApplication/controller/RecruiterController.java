package Talent.TalentStreamApplication.controller;
...
import Talent.TalentStreamApplication.Service.RecruiterService;
import Talent.TalentStreamApplication.entity.APIResponse;
...
@Autowired
 private RecruiterService recruiterservice;
  ...
  @PostMapping(value = "/postjob/{email}", consumes = MediaType.APPLICATION_JSON_VALUE)
